...
export class LevelConfig {
    ...
    static getSpawnCoordinates(
        ...
        // Only a confirmed point. CurrentLevel/PreviousLevel used to be read here; they are
        // dead-reckoned -- `entity.x/y`, a sum of movement deltas on a base the client silently
        // corrects whenever it snaps a spawn onto floor or lets one fall -- so replaying them is
        // what put players in the air on entry, and the error compounded on every visit.
