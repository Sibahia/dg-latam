...
export class SocialHandler {
    ...
    private static getTeleportTargetPosition(target: Client): PendingTeleport | null {
        ...
        // a friend who is mid-jump would drop the traveller in from that height. Only a
        // confirmed grounded sample (the anchor's own client) or a confirmed spawn record is
        // floor.
