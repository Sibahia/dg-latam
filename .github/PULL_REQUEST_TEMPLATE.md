...
- Which player, operator, or developer behavior is affected?
...
- Version bump: `patch` / `minor` / `major` — resulting version:
- Documentation or configuration changes:
- Known limitations, follow-up work, or verification not run:
